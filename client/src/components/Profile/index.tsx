...
class Profile extends React.Component<IComponentProps> {
  render() {
    ...
    return (
      <div className="w-full bg-white fixed md:relative flex flex-row lg:flex-col lg:space-y-10">
        <div className="hidden lg:block text-2xl lg:text-3xl p-2 mt-10">My Account</div>
        <div className="w-full flex flex-col md:flex-row justify-between lg:flex-col lg:space-y-6">
          <button
            type="button"
