...
class ResetPassword extends React.Component<IProps, IState> {
    ...
    handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (this.state.token) {
            ...
            if (isSuccess(result)) this.setState({ isResetSuccessful: true });
        }
    };
            ...
            <div className="flex justify-center w-full">
                {isTokenParsed ? (
                    <div className="shadow-xl flex flex-col items-center sm:w-1/2 lg:w-1/3">
                        <div className="rounded-t text-xl bg-blue-400 p-2 w-full text-white text-center">
                            Reset password
                        </div>
                        {isResetSuccessful ? (
                            ...
                            <div className="p-8">
                                <p className="text-center">
                                    Please enter a new password. Password must have greater than 8 characters and
