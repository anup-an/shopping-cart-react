        ...
        return (
            <div className="flex flex-row flex items-center justify-center w-full">
                ...
                <div className="bg-white border rounded-lg shadow-xl w-2/3 flex flex-row items-center lg:bg-blue-800">
                    ...
                    <div className="w-full lg:w-1/2 bg-white flex flex-col items-center justify-center space-y-8 p-4">
                        ...
                        <form onSubmit={this.handleRegister} className="flex flex-col space-y-4 w-full">
