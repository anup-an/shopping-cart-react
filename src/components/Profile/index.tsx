        ...
        return (
            ...
            <div className="flex flex-col space-y-6">
                <button
                    ...
                    className={`flex flex-row items-center space-x-4 hover:bg-gray-300 ${focus === "details" ?
                        "bg-blue-400 hover:bg-blue-800 text-white" : ''} focus:outline-none border-0 rounded px-2 py-1`}>
                    <svg
                ...
                <button
                    ...
                    className={`flex flex-row items-center space-x-4 hover:bg-gray-300 ${focus === "address" ?
                        "bg-blue-400 hover:bg-blue-800 text-white" : ''} focus:outline-none border-0 rounded px-2 py-1`}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none" stroke="currentColor"
                ...
                <button
                    ...
                    className={`flex flex-row items-center space-x-4 hover:bg-gray-300 ${focus === "orders" ?
                        "bg-blue-400 hover:bg-blue-800 text-white" : ''} focus:outline-none border-0 rounded px-2 py-1`}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none" stroke="currentColor"
